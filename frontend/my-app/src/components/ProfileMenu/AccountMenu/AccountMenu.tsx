          ...
          <div className="about__section-about--flex">
            <div className="about__image-block">
              ...
              <div className="about__social">
                <a href="https://web.telegram.org/" target="_blank"><img src="/shelter-service/images/telegram__image.svg" alt="telegram image" /></a>
                <a href="https://mail.google.com/" target="_blank"><img src="/shelter-service/images/email__image.svg" alt="email image" /></a>
              </div>
            </div>
            <div>
