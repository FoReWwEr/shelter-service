        ...
        <div className='edit__flex'>
          ...
          <section className='edit__social'>
            <div className='edit__social--block'>
              <img src="/shelter-service/images/instagram__image.svg" alt="instagram image" width={32} />
              <img src="/shelter-service/images/telegram__image.svg" alt="telegram image" width={32} />
            </div>
