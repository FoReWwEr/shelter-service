interface Props {
  ...
  togglePasswordVisibility: (visibility: 'password' | 'confirmPassword') => void;
}

export const RegistrationMenu = ({ visibility, togglePasswordVisibility }: Props) => (
  <>
    ...
    <div className='loginSection__form--block'>
      <label className='loginSection__form--text'>Повторіть пароль</label>
      <input type={visibility.confirmPassword ? "text" : 'password'} className='loginSection__form--input' placeholder='12345678' />
      <img
        src="/shelter-service/images/eye-password__image.svg"
        alt="eye image"
        className='loginSection__form--image loginSection__form--image--register'
